...
<html>
    ...
    <body>
        <div class="container">
            ...
            <form autocomplete="off" class="form-signin" method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                <br>
                <div id = "mgTitle" class = "mb-4">
                    <img  class = "" width = 65% height = 65% src = "assets/img/logo.png"/>
            ...
            jQuery('#wang').text('$error').fadeTo('slow', 1).delay(1000)
            .fadeTo('slow', 0);
